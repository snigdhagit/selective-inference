...
df = pd.read_csv('/Users/snigdhapanigrahi/adjusted_MLE/results/metrics_beta_type1_full_rho_0.0.csv')
#df_risk = pd.read_csv('/Users/snigdhapanigrahi/adjusted_MLE/results/risk_beta_type1_full_rho_0.0.csv')
order = ["Selective MLE", "Lee", "Naive"]
cols = ["#3498db", "#9b59b6", "#e74c3c"]

def inference_result():
    # Create a figure for comparing coverage and lengths
    ...
    sns.pointplot(x="SNR", y="coverage", hue_order=order, markers='o', hue="method", data=df, ax=ax1,
                  palette=cols)
    sns.pointplot(x="SNR", y="length", hue_order=order, markers='o', hue="method", data=df, ax=ax2,
                  palette=cols)
    ...
    ax1.set_xlim(0.10, 1.23)
    ax2.set_ylim(0.10, 1.23)
    ...
    plt.savefig('/Users/snigdhapanigrahi/adjusted_MLE/results/plots/intervals_beta_type1_full_rho_0.pdf', format='pdf', bbox_inches='tight')
